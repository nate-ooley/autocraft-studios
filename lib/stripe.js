...
// Pulls the durable sale fields out of a completed Checkout session so they can
// be written to the order row (amount actually charged, currency, Stripe ids).
export function saleDetailsFromSession(session) {
